...
@InputType()
class FeedbackCreateNestedManyWithoutAppointmentsInput {
...
export { FeedbackCreateNestedManyWithoutAppointmentsInput as FeedbackCreateNestedManyWithoutAppointmentsInput };
