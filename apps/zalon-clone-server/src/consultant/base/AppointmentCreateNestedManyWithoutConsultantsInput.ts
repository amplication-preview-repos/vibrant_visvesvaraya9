...
@InputType()
class AppointmentCreateNestedManyWithoutConsultantsInput {
...
export { AppointmentCreateNestedManyWithoutConsultantsInput as AppointmentCreateNestedManyWithoutConsultantsInput };
